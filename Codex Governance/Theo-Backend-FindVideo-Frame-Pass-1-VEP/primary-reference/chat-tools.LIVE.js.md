...
GET-verified from Kudu this turn. Verbatim, full — no ellipsis. This VEP adds only the additive `theo_find_video` registry entry; everything else is byte-identical.
