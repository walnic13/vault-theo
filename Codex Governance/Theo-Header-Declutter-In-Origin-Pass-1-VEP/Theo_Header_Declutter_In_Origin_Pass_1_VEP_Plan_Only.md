...
Pass: Pass 1
Turn issued against HEAD: 6bffd401c7e98eb3a8e1ebaba84984c9a72b5402
...
| 2 | THEO PHASE 1A FRONTEND PLAN — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/THEO_PHASE_1A_FRONTEND_PLAN.md | Read (§0 status; §1 purpose — F-P1 authority) this turn | blob `901271478e8bec29177d379fadbbf3d4701a90fe` (structural, §8 fallback) |
| 3 | THEO API SPEC — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/spec/THEO_API_SPEC.md | Read (§0 scope/status — F-P3) this turn; **N/A to this microstep** — the change is presentational (no in-scope contract; the header reads only in-memory `t`/swap-block constants) | blob `a2b420f9ffe2676abf5cb466bef5039f177ea9f9` (structural, §8 fallback) |
| 4 | THEO FRONTEND GROUNDING CONFORMANCE STANDARD — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/THEO_FRONTEND_GROUNDING_CONFORMANCE_STANDARD.md | Read (§3 GCR; §4/§4A turn-type + sub-phase; §4B VA registry; §5 Rule Anchor; §8 currency) this turn | blob `c614d51c49a0870bb7a4903e63f96ce2dbef314d` (structural, §8 fallback) |
| 5 | CODEX THEO FRONTEND REVIEW STANDARD — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/CODEX_THEO_FRONTEND_REVIEW_STANDARD.md | Read (§0 scope — reviewer behavior) this turn | blob `e2b7e0ba91486371414da688ae3697f02a11e252` (structural, §8 fallback) |
...
| 7 | THEO EXECUTION ORCHESTRATION STANDARD (§4B registry + F-P1 role vocabulary / Decision Register) — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/THEO_EXECUTION_ORCHESTRATION_STANDARD.md | Read (§scope — role vocabulary + Decision-Register owner) this turn; no in-scope Decision-Register entry for this presentational microstep | blob `be066f12147d1eb13b51f025b275f5413ab51f0e` (structural, §8 fallback) |
| 8 | VA-T2 (architecture) + VA-T4 (§3A Theo-in-Origin mount) — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/THEO_ARCHITECTURE_AND_STRUCTURE.md | Read (§3A hosted mount: in-app right-hand Theo panel) this turn | blob `07451ce9d912830b3c15fedf74761d00c59f97b2` (structural, §8 fallback) |
| 9 | VA-T3 — Theo 1A Frontend Handover — c:/Users/WalterMansfield/Vault Group LLP/Innovate - Documents/Tax Workpapers Project/2026/vault-theo/governance/THEO_1A_FRONTEND_HANDOVER.md | Read (§0 what this pack is — productionisation contract) this turn | blob `b8155889ebfb44a153192e63796812a94aa87004` (structural, §8 fallback) |
