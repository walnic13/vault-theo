...
Turn issued against HEAD: `@@ISSUED_HEAD@@` (vault-theo, `development`; grounding parent `00cb17a5dd306a3d1deea7c3162fd2cfc34b5491`). Working tree also carried untracked `artifacts/*.xlsx` (Class B disclosed workbook dirt — not source/governance).
