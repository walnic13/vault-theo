...
Turn issued against HEAD: `@@ISSUED_HEAD@@` (vault-theo, `development`; grounding parent `b29e2ebe8c6029cb6fb6d9ed8bb4cc23343563a6`). Working tree also carried untracked `artifacts/*.xlsx` (Class B disclosed workbook dirt — not source/governance).
