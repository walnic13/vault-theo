...
Pass: Pass 1
Sub-phase Track: P5
Turn issued against HEAD: vault-theo `c8a251f87340cefc82a9f020d75ecc9fb7156a99` (the commit that contains this package, incl. the Pass-2 T13 clamp fix + doc alignment).
...
### Currency anchors (blob SHAs @ HEAD `c8a251f`)
