...
| 3 | APPROVED PASS-1 VEP (declares the gaps; defines the row + DDL) — `Codex Governance/Vault-L1_5-Schema-TagGuard-Stage0-7-2-Pass-1-VEP/Vault_L1_5_Schema_TagGuard_Stage0_7_2_VEP.md` | Codex-APPROVED (`3525b68`); §7/§8 re-read this turn | `git rev-parse HEAD:<path>` (approval commit `3525b68`) |
