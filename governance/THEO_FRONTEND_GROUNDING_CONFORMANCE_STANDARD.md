...
|-------|--------------|------|-------|--------|
| VA-T1 | Theo Frontend Reference Surface | `frontend/theo-frontend-reference.jsx` | The definitive Claude-for-Teams replica surface: sidebar (Chats/Projects/Artifacts/Customize), live chat, Projects (instructions + knowledge), versioned Artifacts side panel, Customize, app-context chip. The exact approved surface — reproduce faithfully, do not redesign (1A handover §0/§0.1). | CURRENT — **pending byte-preserving canonical delivery** (verify `sha256 fe473eed3364505824639d3ef0c9fd0059f2d1ae164ae22976fc3268aed33f2a`) |
| VA-T2 | Theo Architecture and Structure | `governance/THEO_ARCHITECTURE_AND_STRUCTURE.md` | Foundation: repo boundaries, model gateway, Origin→Theo context contract, tool-dispatch, `theo_` schema/RLS, RAG, 1A/1B seam | CURRENT — **pending canonical delivery** |
| VA-T3 | Theo 1A Frontend Handover | `governance/THEO_1A_FRONTEND_HANDOVER.md` | Productionisation contract for the 1A surface (gateway swap, contracts-vs-mocks, app-context layer, per-surface real-in-1A vs true-in-1B, guardrails, acceptance criteria) | CURRENT — **pending canonical delivery** |
